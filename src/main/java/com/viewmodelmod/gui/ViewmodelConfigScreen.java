...
public class ViewmodelConfigScreen extends Screen {
    ...
    private void applyPreset(String name) {
        ViewmodelConfig.INSTANCE.applyPreset(name);
        this.clearChildren();
        this.init();
    }
    ...
    protected void init() {
        ...
        this.addDrawableChild(ButtonWidget.builder(
                ...
                btn -> { ViewmodelConfig.save(); this.close(); })
    ...
    private int addSectionTitle(int x, int y) {
        return y + 14;
    }
    ...
    private int addSlider(int x, int y, String label, float min, float max, float initial,
        ...
        this.addDrawableChild(new SliderWidget(x, y, SLIDER_WIDTH, SLIDER_HEIGHT,
            ...
            @Override protected void applyValue() {
                onChange.accept(min + (float) this.value * range);
            }
        });
